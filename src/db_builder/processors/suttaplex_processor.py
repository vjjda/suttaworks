...
class SuttaplexProcessor:
    ...
    def __init__(self, suttaplex_config: Dict[str, Any], biblio_map: Dict[str, str]): # Thay đổi: config giờ là Dict
        self.suttaplex_config = suttaplex_config
        self.biblio_map = biblio_map
        # THAY ĐỔI Ở ĐÂY: Lấy đường dẫn file trực tiếp từ config
    ...
    def _parse_config_paths(self):
        ...
        # THAY ĐỔI Ở ĐÂY: Truy cập config trực tiếp, không cần lặp qua list
    ...
    def process(self) -> Tuple[List[Dict[str, Any]], ...]:
        ...
        # THAY ĐỔI Ở ĐÂY: Truyền suttaplex_file thay vì suttaplex_dir
